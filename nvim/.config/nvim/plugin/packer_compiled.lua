...
_G.packer_plugins = {
  ["auto-session"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/auto-session"
  },
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/bufdelete.nvim"
  },
  ["cmp-buffer"] = {
    loaded = true,
  ...
  ["cmp-vsnip"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/cmp-vsnip"
  },
  dracula = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/dracula"
  },
  ["formatter.nvim"] = {
    loaded = true,
  ...
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/galaxyline.nvim"
  },
  ["gitsigns.nvim"] = {
    loaded = true,
  ...
  ["mkdir.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/mkdir.nvim"
  },
  ["nest.nvim"] = {
    loaded = true,
  ...
  ["nvim-treesitter-refactor"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/nvim-treesitter-refactor"
  },
  ...
  ["spellsitter.nvim"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/spellsitter.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["vim-unimpaired"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-unimpaired"
  },
  ["vim-vsnip"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-vsnip"
  },
  ["vim-vsnip-integ"] = {
    loaded = true,
    path = "/home/james/.local/share/nvim/site/pack/packer/start/vim-vsnip-integ"
  }
}
